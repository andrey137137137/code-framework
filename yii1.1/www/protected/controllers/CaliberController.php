...
class CaliberController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Caliber'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Caliber');
	...
	{
		$model=new Caliber('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Caliber']))
			$model->attributes=$_GET['Caliber'];
	 ...
	 * @return Caliber the loaded model
	 * @throws CHttpException
	 
	public function loadModel($id)
	{
		$model=Caliber::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Caliber $model the model to be validated
	 
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='caliber-form')
		{
