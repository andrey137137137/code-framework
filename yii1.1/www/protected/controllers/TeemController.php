...
class TeemController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Teem');
	...
	{
		$model=new Teem('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Teem']))
			$model->attributes=$_GET['Teem'];
	 ...
	 * @return Teem the loaded model
	 * @throws CHttpException
	 
	public function loadModel($id)
	{
		$model=Teem::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Teem $model the model to be validated
	 
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='teem-form')
		{
